        ...
        <div class="nhud-accordion-char-edit">
            <div class="nhud-accordion-char-top">
                ...
                <div style="flex:1;min-width:0;">
                    ...
                    ${liveData?.outfit ? (() => { const o = liveData.outfit; if (typeof o === 'object') { const worn = Object.values(o).filter(v => v).map(v => typeof v === 'string' ? v.substring(0,30) : '').filter(Boolean); return worn.length ? `<div style="font-size:0.7em;color:#7070a0;">👗 ${worn.join(', ').substring(0,60)}</div>` : ''; } else { return `<div style="font-size:0.7em;color:#7070a0;">👗 ${String(o).substring(0,60)}</div>`; } })() : ''}
